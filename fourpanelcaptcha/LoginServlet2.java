...
public class LoginServlet2 extends HttpServlet{
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			String str[] = request.getRequestURI().toString().split("/");
                        ...
                        sn.setAttribute("lset1i112",id);
			System.out.println("two : "+id);
                        String set1image12 = request.getParameter("lset1image12");
                        sn.setAttribute("lset1i12",set1image12);
		...
		//	out.println(request.getRequestURI());
            ...
            String destination  ="/Multilevelsecurity/Loginset3.jsp";        
